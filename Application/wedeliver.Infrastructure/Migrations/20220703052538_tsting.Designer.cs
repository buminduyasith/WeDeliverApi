...
namespace wedeliver.Infrastructure.Migrations
{
    ...
    [Migration("20220703052538_tsting")]
    partial class tsting
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("wedeliver.Domain.Entities.Admin", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("wedeliver.Domain.Entities.Author", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("wedeliver.Domain.Entities.BookItem", b =>
                {
            ...
            modelBuilder.Entity("wedeliver.Domain.Entities.OrderReport", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("wedeliver.Domain.Entities.BookItem", b =>
                {
                    b.HasOne("wedeliver.Domain.Entities.Author", "Author")
                        .WithMany("Books")
            ...
            modelBuilder.Entity("wedeliver.Domain.Entities.OrderReport", b =>
                {
                    b.HasOne("wedeliver.Domain.Entities.FoodOrder", "Order")
                        .WithMany()
