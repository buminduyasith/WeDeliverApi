...
namespace Wkhtmltopdf.NetCore
{
    public class GeneratePdf : IGeneratePdf
    {
        ...
        {
            return WkhtmlDriver.Convert(WkhtmltopdfConfiguration.RotativaPath, _convertOptions.GetConvertOptions(), html, string.Empty, string.Empty);
        }

        public byte[] GetPDF(string html, string headerHtmlPath, string footerHtmlPath)
        {
            return WkhtmlDriver.Convert(WkhtmltopdfConfiguration.RotativaPath, _convertOptions.GetConvertOptions(), html, headerHtmlPath, footerHtmlPath);
        }
